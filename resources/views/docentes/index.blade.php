...
<section class="container-docentes">
    ...
    <section class="herramientas-docentes">
        <section class="acciones">
            <a class="crear" href="{{ route('docentes.create') }}" style="color: white;">
        ...
        <input class="buscar" type="text" placeholder="Busque un docente">
    </section>

    <table class="registro-docentes">
        <thead>
            <tr>
                <th>Foto</th>
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <img
                        src="{{ $docente->foto ? asset('storage/'.$docente->foto) : asset('img/app/foto-docente.png') }}"
                        alt="Foto">
                </td>

                <td>{{ $docente->nombres }} <br> {{ $docente->apellidos }}</td>
                ...
                <td>
                    <div class="estado" style="color: #50B332;">
                ...
                <td>
                    <div class="acciones-tabla">
                        <a class="accion-editar" href="{{ route('docentes.edit', $docente->id) }}" class="btn-accion">
                            <!-- Icono Editar -->
                        ...
                        <a class="accion-ver" href="{{ route('docentes.show', $docente->id) }}" class="btn-accion">
                            <!-- Icono Ver -->
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
