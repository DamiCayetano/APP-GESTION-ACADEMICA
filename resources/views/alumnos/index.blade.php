...
@endpush
@section('content')
<section class="container-alumno">
    <h1>Alumnos</h1>
    <section class="herramientas-alumno">
        <section class="acciones">
            <a class="crear" href="" style="color: white;">
        ...
        <input class="buscar" type="text" placeholder="Busque un alumno">
    </section>
    <table class="registro-alumnos">
        <thead>
            <tr>
                <th>Foto</th>
        ...
        <tbody>
            <tr>
                <td>
                    <img src="{{ asset('img/app/foto-docente.png') }}" alt="Foto">
                </td>
                <td>Alexander Herrera <br> Campos</td>
                <td>DNI</td>
                <td>21547836</td>
                <td>369852147</td>
                <td>
